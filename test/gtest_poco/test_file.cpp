...
void failmsg(std::string s)
{
	std::cerr << "err is : " << s << std::endl;
}
TEST(file_name, t)
{
	File f("/Users/james/Documents/http.cpp");
	f.moveTo("/Users/james/jameswork/james_clion/testpoco/test/");
	std::cout << f.path();
}
...
TEST(FileTest,testFileAttributes1a)
{

	File f("/Users/james/jameswork/james_clion/testpoco/test/gtest_poco/test.txt");
	assert (f.exists());
...
//	}
	...
	try
	{
		f.moveTo("/Users/james/jameswork/james_clion/testpoco/test/gtest_poco/aaaaaaaa.dat");
		failmsg("file does not exist - must throw exception");
	}
	catch (Exception&)
	{
...
TEST(FileTest, test_list)
{
	std::ofstream ostr("name.dat");
	ostr << "hello, world!" << std::endl;
	ostr.close();
	File name(".");
	std::vector<std::string> ve_files;
	name.list(ve_files);
...
TEST(file_rename, time)
{
	File a("/Users/james/Documents/20191225.imsibak");

	a.renameTo("/Users/james/Downloads/a.b");

}

TEST(rename, time_diff)
{
	File a("/Users/james/Documents/20191225.imsibak");

	rename( "/Users/james/Downloads/a.b","/Users/james/Documents/20191225.imsibak");
