...
TEST(JSONTest,testNullProperty)
{
...
TEST(JSONTEST,testTrueProperty)
{
...
TEST(JSONTEST,testFalseProperty)
{
...
//
//TEST(JSONTEST,testNumberProperty)
//{
//	testNumber(1969);
//	testNumber(-1969);
//	testNumber(1969.5);
...
TEST(JSONTEST,testUnsignedNumberProperty)
{
...
//
//
//TEST(JSONTEST,testNumber64Property)
//{
...
//
//
//TEST(JSONTEST,testUnsignedNumber64Property)
//{
...
//
//
//TEST(JSONTEST,testStringProperty)
//{
...
//
//
//TEST(JSONTEST,testEmptyPropertyName)
//{
//	std::string json = "{\"\": 42}";
//	Parser parser;
//	Var result;
...
//
//
//TEST(JSONTEST,testComplexObject)
//{
//	std::string json =
//			"{"
//			"\"id\": 1,"
...
//
//
//TEST(JSONTEST,testDoubleProperty)
//{
...
//
//
//TEST(JSONTEST,testDouble2Property)
//{
...
//
//
//TEST(JSONTEST,testDouble3Property)
//{
...
//
//
//TEST(JSONTEST,testObjectProperty)
//{
...
//
//
//TEST(JSONTEST,testArrayOfObjects)
//{
...
//
//
//TEST(JSONTEST,testFalseElement)
//{
...
//
//
//TEST(JSONTEST,testNumberElement)
//{
...
//
//
//TEST(JSONTEST,testStringElement)
//{
...
//
//
//TEST(JSONTEST,testEmptyObjectElement)
//{
//	std::string json = "[{}]";
//	Parser parser;
//	Var result;
...
//
//
//TEST(JSONTEST,testDoubleElement)
//{
...
//
//
//TEST(JSONTEST,testSetArrayElement)
//{
//	std::string json = "[]";
//	Parser parser;
...
//
//
//TEST(JSONTEST,testPrintHandler)
//{
...
//
//
//TEST(JSONTEST,testStringifyPreserveOrder)
//{
...
//
//
//TEST(JSONTEST,testValidJanssonFiles)
//{
...
//
//
//TEST(JSONTEST,testInvalidJanssonFiles)
//{
...
//
//
//TEST(JSONTEST,testInvalidUnicodeJanssonFiles)
//{
...
//
//
//TEST(JSONTEST,testNonEscapeUnicode)
//{
...
//
//
//TEST(JSONTEST,testEscapeUnicode)
//{
//	Poco::JSON::Object::Ptr json = new Poco::JSON::Object();
//	std::string chinese("{ \"name\" : \"\\u4e2d\" }");
//	Poco::JSON::Parser parser(new Poco::JSON::ParseHandler());
