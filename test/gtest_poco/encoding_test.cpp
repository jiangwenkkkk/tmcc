////
//// Created by james on 2019-09-06.
////
//
////
...
//
//
TEST( StreamConverterTest,testIdentityASCIIIn)
{
...
//
//
TEST( StreamConverterTest,testIdentityASCIIOut)
{
	ASCIIEncoding encoding;
...
TEST(StreamConverterTest,testIdentityUTF8In)
{
...
TEST( StreamConverterTest,testIdentityUTF8Out)
{
	UTF8Encoding encoding;
...
TEST(StreamConverterTest,testUTF8toASCIIIn)
{
...
//
TEST( StreamConverterTest,testUTF8toASCIIOut)
{
	UTF8Encoding utf8Encoding;
	ASCIIEncoding asciiEncoding;
...
//
//
TEST(StreamConverterTest,testLatin1toUTF8In)
{
	UTF8Encoding utf8Encoding;
...
TEST( StreamConverterTest,testLatin1toUTF8Out)
{
	UTF8Encoding utf8Encoding;
	Latin1Encoding latin1Encoding;
...
//
TEST(StreamConverterTest,testErrorsIn)
{
	UTF8Encoding utf8Encoding;
	Latin1Encoding latin1Encoding;
...
//
TEST( StreamConverterTest,testErrorsOut)
{
	UTF8Encoding utf8Encoding;
	Latin1Encoding latin1Encoding;
...
TEST( StreamConverterTest,test_cant_see_char)
{
	UTF8Encoding utf8Encoding;
	Latin1Encoding latin1Encoding;
