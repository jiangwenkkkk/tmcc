...
TEST_F(LogTest, ok)
{
	ELOG << "hello" << "1" << std::endl;
	ILOG << "hello" << "2" << std::endl ;
	ILOG << "hello" << "3" << std::endl ;
	ILOG << "hello" << "4" << std::endl ;
	ILOG << "hello" << "5" << std::endl ;
	ILOG << "hello" << "6" << std::endl ;
	ILOG << "hello" << "7" << std::endl ;
	ILOG << "hello" << "8" << std::endl ;
	ILOG << "hello" << "9" << std::endl ;
	ILOG << "hello" << "10" << std::endl ;
	ILOG << "hello" << "11" << std::endl ;
	ILOG << "hello" << "12" << std::endl ;
	ILOG << "hello" << "13" << std::endl ;
	ILOG << "hello" << "14" << std::endl ;
	ILOG << "hello" << "15" << std::endl ;
	ILOG << "hello" << "16" << std::endl ;
	ILOG << "hello" << "17" << std::endl ;
	ILOG << "hello" << "18" << std::endl ;
	ILOG << "hello" << "19" << std::endl ;
	ILOG << "hello" << "20" << std::endl ;
	ILOG << "hello" << "21" << std::endl ;
	ILOG << "hello" << "22" << std::endl ;
	ILOG << "hello" << "23" << std::endl ;
	ILOG << "hello" << "24" << std::endl ;
}
...
TEST(RedisTest, testAPPEND)
{
	...
	try
	{
		std::string result = rt._redis.execute<std::string>(setCommand);
	...
	try
	{
		Poco::Int64 result = rt._redis.execute<Poco::Int64>(appendCommand);
		assert(result == 11);
	}
	catch (RedisException& e)
	{
	...
	try
	{
		BulkString result = rt._redis.execute<BulkString>(getCommand);
